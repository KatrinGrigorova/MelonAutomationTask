...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("waldenschmid@abv.bg", "walden666", "myworld", "homePage", "Walden", "Sofia", null)]
        [NUnit.Framework.TestCaseAttribute("anabern@abv.bg", "anaCa$hback", "cashback", "homePage", "Ana", "Plovdiv", null)]
        public virtual void CreateANewDeliveryAddressWithInvalidInput(string email, string password, string account_Type, string page, string firstName, string city, string[] exampleTags)
        {
...
#line hidden
#line 9
 testRunner.When(string.Format("I log in with the following {0}, {1} and {2}", account_Type, email, password), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 10
...
#line hidden
#line 13
 testRunner.When("I press Create new address button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 14
 testRunner.Then("Add new address form is displayed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 15
 testRunner.When(string.Format("I fill the following address form data: {0}, {1}", firstName, city), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 16
 testRunner.And("I press Save address button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 17
